 ...
 * @const
 */
rtclient.OPENID_SCOPE = 'https://www.googleapis.com/auth/userinfo.profile'
...
rtclient.getParams = function() {
  ...
  if (queryFragment) {
    if (queryFragment[queryFragment.length - 1] == '/') {
      queryFragment = queryFragment.slice(0, -1);
    }
    hashFragment += '&' + queryFragment.slice(1);
  }
